import 'package:ayurvibe/core/theme/button_styles.dart';
import 'package:ayurvibe/core/theme/palette.dart';
...
ThemeData lightTheme(double fontSize) {
  return ThemeData(
    ...
    iconTheme: IconThemeData(color: Palette.themeColor, size: fontSize),
...
ThemeData darkTheme(double fontSize) {
  return ThemeData(
    ...
    iconTheme: IconThemeData(color: Palette.lightGreyColor, size: fontSize),
    inputDecorationTheme: InputDecorationTheme(
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0)),
